<table style ="width:100%">
    <thead>
        <tr>
            <th colspan="3" style="text-align:center; font-weight: bold; font-size: 14px;"> Laporan Permintaan Divisi Requestor Pada Bulan {{$status[0]->bulan}} {{$status[0]->tahun}} </th>
        </tr>
        <tr>
    ...
    <tr>
        ...
        <th style="text-align:left; font-weight: bold;">Divisi Requestor</th>
    ...
    @foreach($status as $s)
        <tr>
            ...
            <td style="text-align:left" width="30" height="15">{{ $s->div_name }}</td>
